<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
	...
	if ($jenisakses == "admin") {
	?>
		<a class="navbar-brand" href="<?= base_url() ?>admin">Logistik</a>
	<?php
	} elseif ($jenisakses == "pengguna") {
	?>
		<a class="navbar-brand" href="<?= base_url() ?>pengguna">Logistik</a>
	<?php
	} else {
	?>
		<a class="navbar-brand" href="<?= base_url() ?>pemilik">Logistik</a>
	<?php
	}
	?>
