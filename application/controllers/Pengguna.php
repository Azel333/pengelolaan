...
class Pengguna extends CI_Controller
{
	...
	public function excelcetakbrgkeluar()
	{
		...
		$setExcelprop->getProperties()->setCreator("Logisitk");
		$setExcelprop->getProperties()->setLastModifiedBy("Logisitk");
		$setExcelprop->getProperties()->setTitle("Laporan Barang Keluar");

		$setExcelprop->setActiveSheetIndex(0);
		$setExcelprop->getActiveSheet()->setCellValue('C1', 'Laporan Barang Keluar Logisitk');
	...
	public function excelcetakbrgkembali()
	{
		...
		$setExcelprop->setActiveSheetIndex(0);
		$setExcelprop->getActiveSheet()->setCellValue('C1', 'Laporan Barang Kembali Logisitk');
