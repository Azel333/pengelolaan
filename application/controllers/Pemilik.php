...
class Pemilik extends CI_Controller
{
	...
	public function excelcetakhasilprediksi()
	{
		...
		$setExcelprop->getProperties()->setCreator("Logistik");
		$setExcelprop->getProperties()->setLastModifiedBy("Logistik");
		$setExcelprop->getProperties()->setTitle("Laporan Hasil Prediksi Barang");

		$setExcelprop->setActiveSheetIndex(0);
		$setExcelprop->getActiveSheet()->setCellValue('C1', 'Laporan Hasil Prediksi Barang Logistik');
